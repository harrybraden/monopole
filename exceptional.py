...
def exceptional(k, x1, x2, x3):   # If there is a multiple root or branch point a value of maxint-1 will be returned; maxint is globally set.
...
# print exceptional(0.5, 0.84, 0.05, 1.5)
# print exceptional(0.5, 0.82, 0.05, 1.5)

# print is_awc_multiple_root(0.5, 0.84, 0.05, 1.5)
# print is_awc_branch_point(0.5, 0.84, 0.05, 1.5)
